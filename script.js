const questions = [
  {
      ...
      options: [
          ...
          "c) De acordo com o artigo 795, o valor máximo do capital segurado será determinado pela seguradora, e o cliente poderá ter apenas um seguro de vida.",
          "d) O cliente poderá ter apenas um seguro de vida, mas poderá estipular o capital segurado livremente.",
          "e) Cada seguradora deve determinar sua regra, visto que esses temas não estão previstos no Código Civil."
      ],
      correctAnswer: "A"
  },
  // Nova pergunta 2
  {
      question: "2. Quando o estipulante afirma que o seu plano é contributário, ele está dizendo que:",
      options: [
          "a) É uma apólice individual com adesão dos colaboradores.",
          "b) É um estipulante instituidor desse plano.",
          "c) Ele custeia o plano integralmente, sem participação dos segurados.",
          "d) Os segurados são responsáveis pelo pagamento, total ou parcial, dos prêmios.",
          "e) Ele assumiu um papel de estipulante averbador no plano."
      ],
      correctAnswer: "D"
  },
  // Nova pergunta 3
  {
      question: "3. Com tantos instrumentos contratuais, um responsável pela área de recursos humanos de uma empresa entrou em contato com o corretor para esclarecer uma dúvida importante. Nesse caso, ele está em dúvida sobre o que é a proposta de adesão. O corretor deverá explicar que a proposta de adesão é o documento que:",
      options: [
          "a) Formaliza a aceitação da cobertura solicitada pelo proponente, nos planos individuais, ou pelo estipulante, nos planos coletivos.",
          "b) É emitido pela seguradora, dispensando a obrigatoriedade da proposta de contratação e substituindo a apólice.",
          "c) O proponente (pessoa física) usa para expressar a intenção de aderir à contratação coletiva, manifestando pleno conhecimento das condições contratuais.",
  ...
  // Nova pergunta 4
  {
      question: "4. Ao explicar a cobertura de Auxílio Funeral ao seu cliente, o corretor informou:",
      options: [
          "a) Essa cobertura somente garante o reembolso das despesas com o funeral do segurado, sem possibilidade de utilizar o serviço de funeral.",
          ...
          "c) Esse serviço não é cobrado, sendo uma assistência com serviços de funeral.",
...
// Nova pergunta 6
{
    ...
    options: [
      ...
      "c) Sim, já que o inquérito pode determinar que o pagamento da indenização não era devido.",
      "d) Sim, desde que esteja no regulamento que as indenizações apenas serão pagas após todos os documentos serem apresentados, inclusive os relacionados à tramitação de inquérito policial.",
      "e) Depende, pois a seguradora só poderá seguir tal procedimento em casos específicos, determinados pelo Código Civil Brasileiro."
    ],
    correctAnswer: "A",
  },
...
// Nova pergunta 7
{
    ...
    options: [
      ...
      "c) Trata-se de um seguro coletivo, e a empresa estipulante demorou a dar entrada no sinistro.",
      "d) Trata-se de um sinistro por acidente, e a seguradora só pode efetuar o pagamento da indenização após o término do inquérito policial.",
      "e) A seguradora informou, em alguns casos, a análise pode superar os 30 dias determinados na regulamentação."
    ],
    correctAnswer: "B",
  },
  ...
  // Nova pergunta 8
{
    ...
    options: [
      ...
      "c) Trata-se de um seguro coletivo, e a sinistralidade da apólice foi mais alta do que o esperado, por isso, ocorreu o aumento.",
      "d) O cliente contratou coberturas por doença, ou seja, coberturas em que o risco aumenta a cada ano que passa, sendo obrigatório o aumento anual.",
      "e) Não se trata de um aumento, mas de uma atualização, já que os planos estruturados na modalidade de benefício definido deverão conter cláusula de atualização anual de valores."
    ],
    correctAnswer: "E",
  },
  ...
  // Nova pergunta 9
{
    ...
    options: [
      ...
      "c) Ele será categorizado como Estipulante Averbador pois arcará com parte dos prêmios.",
  ...
  // Nova pergunta 10
{
    ...
    options: [
      ...
      "c) Benefício Prolongado e Contribuição Contínua",
      "d) Benefício Temporário e Contribuição Contínua",
      "e) Benefício Variável e Contribuição Definida"
    ],
    correctAnswer: "B",
  },
  ...
  // Nova pergunta 11
{
    ...
    options: [
      ...
      "c) Os filhos podem ser incluídos no seguro até 14 anos de idade.",
      "d) A cláusula suplementar de inclusão de cônjuge e filhos, se facultativa, o colaborador tem opção de incluir ou não seu cônjuge e seus filhos na apólice.",
      "e) A cláusula suplementar de inclusão de cônjuge e filhos só pode ser feita de forma facultativa."
    ],
    correctAnswer: "D",
},
...
// Nova pergunta 12
{
    ...
    options: [
      ...
      "c) Estipulante pode ser uma pessoa física ou jurídica.",
...
// Nova pergunta 13
{
    ...
    options: [
      ...
      "c) Elas são classificadas em 'fixas' ou 'periódicas', 'renda contínua' ou 'renda aleatória'.",
...
// Nova pergunta 14
{
    ...
    options: [
      ...
      "c) Somente deve ser dada a entrada no benefício junto à seguradora após o recebimento de alta da paciente.",
...
// Nova pergunta 17
{
    ...
    options: [
      ...
      "c) É vedada a aplicação de prazo de carência aos aumentos de capital segurado solicitados após a vigência.",
      "d) Em caso de renovação de apólice, será iniciado novo prazo de carência.",
      "e) O prazo de carência, exceto no caso de suicídio ou de sua tentativa, não poderá exceder a metade do prazo de vigência previsto na apólice, no caso de contratação individual, ou pelo certificado, no caso de contratação coletiva."
    ],
    correctAnswer: "E",
},
...
// Nova pergunta 18
{
    ...
    options: [
      ...
      "c) O subscritor analisa se a indenização será paga, baseando-se na documentação apresentada.",
...
// Nova pergunta 19
{
    ...
    options: [
      ...
      "c) Risco, Subscritor e Precificação",
...
// Nova pergunta 20
{
    ...
    options: [
      ...
      "c) Está correta pois a seguradora analisou que atividade em uma plataforma de petróleo oferece mais risco em comparação a um risco padrão.",
...
// Nova pergunta 21
{
    ...
    options: [
      ...
      "c) A probabilidade dessa pessoa sobreviver à idade de 31 anos é de 52,35%.",
...
// Nova pergunta 22
{
    ...
    options: [
      ...
      "c) 30 dias a partir da entrega dos documentos básicos, ressalvando os casos de solicitação de documentação ou informação complementar (quando o prazo será suspenso voltando a correr a partir do primeiro dia útil subsequente ao atendimento completo das exigências de documentos).",
...
// Nova pergunta 23
{
    ...
    options: [
      ...
      "c) Certidão de casamento atualizada e comprovante de residência dos beneficiários.",
...
// Nova pergunta 24
{
    ...
    options: [
      ...
      "c) Correto, desde que a dúvida seja justificável.",
...
// Nova pergunta 25
{
    ...
    options: [
      ...
      "c) A seguradora está certa pois a carência de suicídio é de 48 meses do início de vigência.",
      "d) A seguradora está errada pois o segurado estava fora do período de carência, já que o fato aconteceu após o período de carência de 2 anos.",
      "e) A seguradora está errada pois o suicídio não foi premeditado."
    ],
    correctAnswer: "A",
},
...
// Nova pergunta 27
{
    ...
    options: [
      ...
      "c) Tábuas de Cálculo ou de Longevidade",
...
// Nova pergunta 28
{
    ...
    options: [
      ...
      "c) Multiplicar o capital segurado total do grupo pelo prêmio puro desse grupo.",
...
// Nova pergunta 29
{
    ...
    options: [
      ...
      "c) Os produtos Dotal Misto e Dotal Misto com Performance garantem a cobertura de sobrevivência, mas o Dotal Misto com Performance não possui reversão de resultados financeiros.",
...
// Nova pergunta 30
{
    ...
    options: [
      ...
      "c) Os produtos Dotal Puro e Dotal Misto são estruturados na modalidade de benefício definido, mas o Dotal Misto com Performance é estruturado na modalidade de contribuição variável.",
...
// Nova pergunta 31
{
    ...
    options: [
      ...
      "c) Dotal Puro com Performance",
      "d) Dotal Misto sem Performance",
      "e) Dotal Misto com Performance"
    ],
    correctAnswer: "E",
},
...
// Nova pergunta 32
{
    ...
    options: [
      ...
      "c) O cliente poderá fazer aportes periódicos de qualquer valor.",
...
// Nova pergunta 33
{
    ...
    options: [
      ...
      "c) Os danos de natureza estética, que afetam a aparência do segurado, sem que impliquem perda ou redução da funcionalidade afetadas, desde que provocadas por acidente, estão incluídas na cobertura.",
...
// Nova pergunta 34
{
    ...
    options: [
      ...
      "c) Diárias por Internação Hospitalar (DIH)",
      "d) Doenças Graves (DG)",
...
// Nova pergunta 35
{
    ...
    options: [
      "a) Morte Prematura",
      "b) Morte Acidental",
      "c) Indenização Especial por Acidente (IEA)",
      "d) Sobrevivência",
      "e) Morte"
    ],
    correctAnswer: "E",
...
// Nova pergunta 37
{
    ...
    options: [
      ...
      "c) O bilhete de seguros não substitui a proposta de contratação",
      "d) Nos seguros coletivos quem preenche a proposta de adesão é o estipulante e o segurado preenche a proposta de contratação",
      "e) Após a aceitação de um seguro individual, o segurado receberá seu certificado com todas as informações referentes ao seu seguro."
    ],
    correctAnswer: "B",
},
// Pergunta 38
{
    ...
    options: [
      ...
      "c) No caso da recepção de grupo de segurados e assistidos, originado em migração de apólice, deverão ser admitidos todos os componentes do grupo cuja cobertura esteja em vigor, inclusive os afastados.",
...
// Pergunta 39
{
    ...
    options: [
      ...
      "c) Resgate, Portabilidade, Aporte e Benefício definido",
      "d) Resgate, Aporte, Saldamento e Contribuição Variável",
      "e) Resgate, Benefício Definido, Contribuição variável e Reversão financeira"
    ],
    correctAnswer: "A",
},
...
// Nova pergunta 40
{
    question: "40. Com tantas opções para estabelecer o capital segurado para a apólice de Vida em Grupo de seus funcionários, o Sr Sheldon procurou seu corretor para uma explicação que fizesse ele fazer a coisa certa. O Corretor explicou que para a determinação do Capital Segurado dependerá de alguns fatores como a simplicidade na administração da apólice, o quanto o estipulante pensa em termos de valores. Ainda explicou que há 4 modalidades para se determinar o capital, quando o assunto é uma apólice coletiva, sendo elas:",
    options: [
      "a) Capital fixo, granular, múltiplo salarial e global",
      "b) Capital global, escalonado, múltiplo salarial e uniforme",
      "c) Capital padronizado, global, uniforme e múltiplo fixo",
